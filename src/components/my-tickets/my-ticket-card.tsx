...
export function MyTicketCard({ myTicket }: MyTicketCardProps) {
  return (
    <Link href={`/my-tickets/${myTicket.id}`}>
      <div className="cursor-pointer rounded-m overflow-hidden hover:scale-105 transition-all bg-white border-solid border border-neutral-200 flex items-center relative">
